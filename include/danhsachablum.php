...
LIMIT $a, 15 ");
    ...
    <div class="row">
     ...
     <div class="row">
        ...
        { ?>
          <a href="dsablum.php?theloai=<?php echo $theloai;?>&trang=<?php echo $i; ?>"> <?php echo $i."" ;?></a> <?php
        }?> 
      </div>
    </div><?php 
  } 
    ...
    <div class="row">
     ...
     <div class="row">
        <div class="col-md-10 offset-6">Trang:  <?php 
          for($i=1;$i<=ceil(($slbh/15));$i++)
        { ?>
          <a href="dsablum.php?trang=<?php echo $i; ?>"> <?php echo $i."" ;?></a> <?php
        }?> 
      </div>
    </div><?php 
  }
